...
public class RoverUnitTests
{
    ...
    {
        var rover = new Rover(xCoord, yCoord, bearing, Plateau, Constants.RoverId);
    ...
    {
        var rover = new Rover(0, 0, bearing, Plateau, Constants.RoverId);
    ...
    {
        Assert.Throws<ArgumentException>(() => new Rover(xCoord, yCoord, bearing, Plateau, Constants.RoverId));
    }
    ...
    {
        var rover = new Rover(xCord, yCord, bearing, Plateau, Constants.RoverId);
