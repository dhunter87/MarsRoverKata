...
public class RoverUnitTests
{
    ...
    {
        var rover = new Rover(xCoord, yCoord, bearing, Platau, Constants.RoverId);
    ...
    {
        var rover = new Rover(0, 0, bearing, Platau, Constants.RoverId);
    ...
    {
        Assert.Throws<ArgumentException>(() => new Rover(xCoord, yCoord, bearing, Platau, Constants.RoverId));
    }
    ...
    {
        var rover = new Rover(xCord, yCord, bearing, Platau, Constants.RoverId);
